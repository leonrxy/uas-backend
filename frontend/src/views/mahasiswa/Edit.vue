...
export default {
  setup() {
    ...
    onMounted(() => {
      ...
      axios.get('http://localhost:8000/api/mahasiswa/' + route.params.id, {
        headers: {
      ...
      },
        {
          ...
          post.jenis_kelamin = response.data.data.jenis_kelamin
    ...
    function update() {
      ...
      axios.put('http://localhost:8000/api/mahasiswa/' + route.params.id, {
        nama: nama,
        nim: nim,
        jurusan: jurusan,
      ...
      },
        {
          ...
          showSuccessNotification('Data Berhasil Diubah')
        }).catch(error => {
          //assign state validation with error  
          validation.value = error.response.data
          showErrorNotification('Data Gagal Diubah')
        })
    }
    function goBack() {
      router.push({
